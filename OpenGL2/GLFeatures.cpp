...
bool CheckGLExtensions() {
	...
	gl_extensions.OES_texture_npot = true;
	gl_extensions.OES_depth24 = true;
	gl_extensions.OES_depth_texture = true;
	gl_extensions.EXT_blend_minmax = true;
	gl_extensions.ARB_framebuffer_object = true;
	gl_extensions.EXT_copy_image = false;
	gl_extensions.OES_mapbuffer = false;
	gl_extensions.ARB_stencil_texturing = false;
	extensionsDone = true;
	return true;
#endif
